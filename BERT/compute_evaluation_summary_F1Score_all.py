...
if __name__ == '__main__':
    ...
    plt.xscale('log')
    plt.title('F1-Score Vergleich für Tatoeba Testdatei - ' + base_path[base_path.find("/")+8:base_path.rfind("/")])
    plt.xlabel('Samples')
    ticks = df['Samples']
    ...
    plt.savefig(str(base_path[:base_path.rfind('/')] + '/' + base_path[2:base_path.rfind('/')] + '_test_tatoeba_plot.png'), dpi=300)
    plt.show()
